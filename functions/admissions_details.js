...
document.getElementById("total_applicants_details").addEventListener("click", function () {
  expandCard(this, "applicants");
});

document.getElementById("school_managers_details").addEventListener("click", function () {
  expandCard(this, "school_managers");
});

document.getElementById("total_students_details").addEventListener("click", function () {
  expandCard(this, "students");
});
document.getElementById("listed_courses_details").addEventListener("click", function () {
  expandCard(this, "listed_courses");
});
document.getElementById("pending_admissions_details").addEventListener("click", function () {
  expandCard(this, "pending_admissions");
});
document.getElementById("rejected_admissions_details").addEventListener("click", function () {
  expandCard(this, "rejected_admissions");
});
document.getElementById("accepted_admissions_details").addEventListener("click", function () {
  expandCard(this, "accepted_admissions");
});
