...
document.getElementById("active_student_details").addEventListener("click", function () {
  expandCard(this, "active_students");
});

document.getElementById("pending_registration_details").addEventListener("click", function () {
  expandCard(this, "pending_registration");
});

document.getElementById("graduated_students_details").addEventListener("click", function () {
  expandCard(this, "graduated_students");
});
document.getElementById("withdrawn_students_details").addEventListener("click", function () {
  expandCard(this, "withdrawn_students");
});
