...
document.getElementById("graded_courses_details").addEventListener("click", function () {
  expandCard(this, "graded_courses");
});

document.getElementById("graded_students_details").addEventListener("click", function () {
  expandCard(this, "graded_students");
});

document.getElementById("total_exam_details").addEventListener("click", function () {
  expandCard(this, "exams");
});
document.getElementById("pending_courses_details").addEventListener("click", function () {
  expandCard(this, "pending_courses");
});
