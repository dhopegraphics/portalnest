...
document.getElementById("see_full_applicants_details").addEventListener("click", function () {
  expandCard(this, "applicants");
});
document.getElementById("see_full_staff_details").addEventListener("click", function () {
  expandCard(this, "staff");
});
document.getElementById("see_full_student_details").addEventListener("click", function () {
  expandCard(this, "students");
});
document.getElementById("see_full_listed_courses_details").addEventListener("click", function () {
