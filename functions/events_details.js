...
document.getElementById("total_events_details").addEventListener("click", function () {
  expandCard(this, "total_events");
});

document.getElementById("ongoing_events_details").addEventListener("click", function () {
  expandCard(this, "ongoing_events");
});

document.getElementById("closed_events_details").addEventListener("click", function () {
  expandCard(this, "closed_events");
});
document.getElementById("completed_events_details").addEventListener("click", function () {
  expandCard(this, "completed_events");
});
