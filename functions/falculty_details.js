...
document.getElementById("total_faculties_details").addEventListener("click", function () {
  expandCard(this, "total_faculties");
});

document.getElementById("falculitie_departments_details").addEventListener("click", function () {
  expandCard(this, "falculitie_departments");
});

document.getElementById("hods_assigned_details").addEventListener("click", function () {
  expandCard(this, "hods_assigned");
});
document.getElementById("unassigned_departments_details").addEventListener("click", function () {
  expandCard(this, "unassigned_departments");
});
