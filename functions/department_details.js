...
document.getElementById("falculitie_departments_departments_details").addEventListener("click", function () {
  expandCard(this, "falculitie_departments");
});

document.getElementById("assigned_lecturers_details").addEventListener("click", function () {
  expandCard(this, "assigned_lecturers");
});

document.getElementById("unassigned_courses_details").addEventListener("click", function () {
  expandCard(this, "unassigned_courses");
});
