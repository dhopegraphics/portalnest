...
document.getElementById("totalCourses_details").addEventListener("click", function () {
  expandCard(this, "listed_courses");
});

document.getElementById("lecturers_details").addEventListener("click", function () {
  expandCard(this, "lecturers");
});

document.getElementById("assigned_lecturers_details").addEventListener("click", function () {
  expandCard(this, "assigned_lecturers");
});
document.getElementById("unassigned_lecturers_details").addEventListener("click", function () {
  expandCard(this, "unassigned_lecturers");
});
